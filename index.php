...
<br><br>
  ...
  <div class="wrapper">
    <div class="social-icons">
      ...
      <a href="https://www.facebook.com/" style="animation: fadeIn 1s ease-in-out forwards;">Facebook<i class="fab fa-facebook" style="color: #d8dee8; padding-left: 10px;  height: 20px;"></i></a>

      <a href="https://www.instagram.com/" style="animation: fadeIn 1s ease-in-out 0.2s forwards;">Instagram<i class="fab fa-instagram" style="color: #d4d9e3; padding-left10px"></i></a>

      <a href="#" style="animation: fadeIn 1s ease-in-out 0.4s forwards;">Twitter<i class="fab fa-twitter" style="padding-left: 10px;"></i></a>
    </div>
