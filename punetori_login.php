...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $stmt = $pdo->prepare("SELECT * FROM punetori WHERE email = :email AND password = :password");
...
<h2 style="text-align: center; font-weight: bold;">Welcome Staf!</h2>
<form method="post" action="punetori_login.php" >
...
<div id="video-container">
  <video autoplay loop muted plays-inline type="video/mp4" id="bgvid">
    <source src ="cheff.mp4">
  </video>
</div>
